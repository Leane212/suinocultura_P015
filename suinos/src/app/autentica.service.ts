...
export class AutenticaService {
  ...
  signupUser(email: string, password: string) {
   return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAc16F_48VTX1eydT5x3MMBGHhplvg1Z6E', 
   {
      email: email,
      password: password,
  ...
  loginUser(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAc16F_48VTX1eydT5x3MMBGHhplvg1Z6E',
    {
      email: email,
      password: password,
      returnSecureToken: true
